...
public class EstructurasDeControl {
	...
	public static void main(String[] args) {
		...
		// Recordar que para que algo se ejecute, siempre debe ir dentro del método
		// principal
		...
		// La variable declarada, se inicia en null a propósito para tener un espacio de
		// memoria ya asignado y solo reemplazarlo con un nuevo dato.
		...
		switch (opcion) {
		case 1:
			System.out.println("Usted ha seleccionado la opción programar cita."); // Agrega la lógica para programar
																					// una cita
			break;
		case 2:
		...
		default:
			System.out.println(
					"La opción que usted seleccionó no es válida. Por favor seleccione una opción del menú (1-4)");
			break;
		} // switch
