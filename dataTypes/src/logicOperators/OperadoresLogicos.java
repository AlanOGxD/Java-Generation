...
public class OperadoresLogicos {
	public static void main(String[] args) {
		...
		/*
		 * -- Operadores aritméticos (+, -, *, /, %) -- Operadores lógicos (AND, OR,
		...
		/*
		 * Relacionales = asignación += asignación suma -= asignación resta = asignación
		 * multiplicación /= asignación división == igual que != distinto que < menor
		 * que > mayor que <= menor igual que >= mayor igual que
		 */
